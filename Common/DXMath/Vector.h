...
namespace Math
{
	...
	public:
		...
		INLINE  Vector3(EZeroTag) { m_vec = SplatZero(); }
		INLINE  Vector3(EIdentityTag) { m_vec = SplatOne(); }
		INLINE  Vector3(EXUnitVector) { m_vec = CreateXUnitVector(); }
		INLINE  Vector3(EYUnitVector) { m_vec = CreateYUnitVector(); }
		INLINE  Vector3(EZUnitVector) { m_vec = CreateZUnitVector(); }
	...
	public:
		...
		INLINE  Vector4(EZeroTag) { m_vec = SplatZero(); }
		INLINE  Vector4(EIdentityTag) { m_vec = SplatOne(); }
		INLINE  Vector4(EXUnitVector) { m_vec = CreateXUnitVector(); }
		INLINE  Vector4(EYUnitVector) { m_vec = CreateYUnitVector(); }
		INLINE  Vector4(EZUnitVector) { m_vec = CreateZUnitVector(); }
		INLINE  Vector4(EWUnitVector) { m_vec = CreateWUnitVector(); }
